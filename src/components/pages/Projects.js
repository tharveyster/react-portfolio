...
const projects = [
  {
    ...
    resources: 'HTML, CSS, JavaScript, Node, Express, MongoDB, Mongoose, IndexedDB',
  ...
  },
  {
    ...
    resources: 'HTML, CSS, JavaScript, MongoDB, Mongoose, Node, Express, Morgan',
  ...
  },
  {
    ...
    resources: 'HTML, CSS, JavaScript, Node, Express, Handlebars, MySQL, Axios, APIs',
  ...
  {
    title: 'Tech Blog',
    resources: 'HTML, CSS, JavaScript, Node, Express, Handlebars, MySQL, BCrypt, Sequelize, Sequelize Session',
  ...
  },
  {
    ...
    deployed: 'https://drive.google.com/file/d/17oLpM-PeuqrqMFMzOfQr04hDl0CEhrkR/view',
    image: pic5,
    alt: 'E-Commerce Back-End'
  },
  {
    title: 'FlixFinder',
    resources: 'HTML, CSS, JavaScript, Server Side APIs (OMDB, Google Youtube, TMDB)',
